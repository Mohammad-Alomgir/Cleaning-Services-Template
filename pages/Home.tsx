      ...
      <section className="py-24 bg-white">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div className="relative">
              <img src="https://picsum.photos/seed/servicecenter/500/700" alt="Cleaner" className="rounded-2xl mx-auto shadow-xl" />
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {[
              ...
              { label: 'Activate Project', count: '285+' },
              { label: 'Awards Winning', count: '27+' },
            ].map((stat, i) => (
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {PRICING_PLANS.map((plan) => (
              <div key={plan.id} className={`p-8 bg-white rounded-xl shadow-sm border ${plan.isPopular ? 'border-spark-blue ring-2 ring-spark-blue ring-opacity-10 scale-105 relative z-10' : 'border-transparent'} hover:shadow-xl transition-all`}>
                {plan.isPopular && (
